...
namespace NMib
{
	namespace NProcess
	{
		...
		typedef NContainer::TCStreamableVariant<EProcessLaunchState, void *, EProcessLaunchState_Launched, NMib::NStr::CStr, EProcessLaunchState_LaunchFailed, uint32, EProcessLaunchState_Exited> CProcessLaunchStateChangeVariant;
