...
bool NMib::NProcess::NPlatform::fg_MacOSX_Process_RegisterAtStartup(NStr::CStr const& _ExePath, NStr::CStr const &_Params, NStr::CStr const& _Name)
{			
...
bool NMib::NProcess::NPlatform::fg_MacOSX_Process_DeRegisterAtStartup(NStr::CStr const& _ExePath, NStr::CStr const &_Params, NStr::CStr const& _Name)
{
	if (!_Params.f_IsEmpty())
	{
