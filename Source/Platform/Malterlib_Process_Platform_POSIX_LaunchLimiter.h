...
namespace NMib
{
	namespace NProcess
	{
		namespace NPlatform
		{
			struct CProcessLaunchLimiter : public NPtr::TCSharedPointerIntrusiveBase<>
			{
				...
				NPtr::TCUniquePointer<NThread::CThreadObject> m_pUpdateThread;
			...
			typedef NPtr::TCSharedPointer<CCPULimiterRef> CSharedLimiter;
